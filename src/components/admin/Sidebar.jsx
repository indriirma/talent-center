...
const menuItems = [
  ...
  { icon: PeopleAltIcon, label: 'Daftar Talent', tooltip: 'Daftar Talent' },
  { icon: BusinessCenterIcon, label: 'Daftar Client', tooltip: 'Daftar Client' },
  { icon: AssignmentIcon, label: 'Daftar Persetujuan Talent', tooltip: 'Daftar Persetujuan Talent', active: true },
